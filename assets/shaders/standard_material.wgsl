// oh my god... maintaining this across bevy versions is hell
// OK, not really, more like wet socks on the severity scale

#define_import_path grin::fragment // NOTE: changed from original!
...
fn fragment(
    ...
    if ((pbr_bindings::material.flags & pbr_types::STANDARD_MATERIAL_FLAGS_BASE_COLOR_TEXTURE_BIT) != 0u) {
        output_color = output_color * textureSampleBias(pbr_bindings::base_color_texture, pbr_bindings::base_color_sampler, uv, pbr_bindings::material.layer, view.mip_bias); // NOTE: changed from original!
    }
#endif
